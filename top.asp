...
<div class="header">
    ...
    <div class="nav_logo">
        ...
        <div class="menus">
            ...
            <li><a href="about.asp" class="ap">关于我们</a><ul style="margin-left: -5px;" >
  ...
  <li><a href="About.asp?a=<%=res("id")%>"  ><%=res("classid")%></a></li>
	...
	<li><A href="honor.asp" >公益与荣誉</A></li>
            ...
            <li><a href="news.asp" class="ap" >新闻资讯</a><ul style="margin-left: -8px;" >
...
<%
            ...
            <li><a href="platform.asp" class="ap" >并购公众平台</a><ul style="margin-left: -8px;" >
