...
config.AllowRemoteSize = "1000";
config.AllowLocalSize = "1000";
...
config.Toolbars = [
	["TBHandle", "FormatBlock", "FontName", "FontSize", "Bold", "Italic", "UnderLine", "TBSep", "TBSep", "JustifyLeft", "JustifyCenter", "JustifyRight", "JustifyFull"],
	...
	["TBHandle", "Image", "Flash", "Media", "File", "GalleryMenu", "TBSep", "TableMenu", "FormMenu", "TBSep", "Fieldset", "Iframe", "HorizontalRule", "Marquee", "CreateLink", "Unlink", "Map", "Anchor", "TBSep", "Template", "Symbol", "Emot", "Art", "Excel", "Quote", "ShowBorders", "TBSep", "Maximize"]
];
