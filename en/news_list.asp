...
if keys<>"" then
mypage.getsql="select * from jiedai_News where  e_title like '%"&keys&"%' order by tuijian desc,id desc"
else
mypage.getsql="select * from jiedai_News where classid="&N&"  and e_title<>'' order by tuijian desc,id desc"
end if
