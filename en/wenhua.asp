...
<% 	set ris=server.createobject("adodb.recordset")
	...
	sqli="select * from jiedai_qita where id=7"
	else
...
<!-- .nleft -->
  ...
  <li><a href="wenhua.asp?a=<%=res("id")%>" <%if aid=int(res("id")) or i=0 then  response.Write"class=""focus""" end if%> ><%=res("e_classid")%></a></li>
