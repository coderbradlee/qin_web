...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=5 height=25>下载分类管理</th>	
  </tr>
  <tr>
    <td width="33%" class="forumRowHighlight"><div align="center">下载分类名称</div></td>
    <td width="21%" class="forumRowHighlight"><div align="center">下载分类排序</div></td>
    ...
    <%set rs=server.CreateObject("adodb.recordset")
		  ...
		  do while not rs.EOF
	%>
     <form name="form1" method="post" action="savefwclass.asp?action=edit&id=<%=int(rs("anclassid"))%>">
    <tr>
     ...
     <td class="forumRowHighlight"><div align="center"><input class="button" type="submit" name="Submit" value="修  改">&nbsp; <a href="savefwclass.asp?id=<%=int(rs("anclassid"))%>&action=del" onClick="return confirm('此操作会删除此大类下包含的小分类和商品！您确定进行删除操作吗？')"><font color=red>删除</font></a> </div></td>
   </tr>
   </form>
   <%rs.MoveNext
          loop
...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=5 height=25>添加下载分类</th>	
  </tr>
  <tr> 
 ...
 <form name="form1" method="post" action="savefwclass.asp?action=add">
  <tr>
