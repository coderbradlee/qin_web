...
Private Function ShowFirstPrv()
 ...
 If int_curpage=1 Then
  str_tmp="<li><span>"&Btn_First&"</span></li>" & VbCrLf
  str_tmp=str_tmp&"<li><span>"&Btn_Prev & "</span></li>" & VbCrLf
 Else
  int_prvpage=int_curpage-1
  str_tmp="<li><a href="""&XD_sURL & "1" & """>" & Btn_First&"</a></li>" & VbCrLf
  str_tmp=str_tmp&"<li><a href=""" & XD_sURL & CStr(int_prvpage) & """>" & Btn_Prev&"</a></li>" & VbCrLf
 End If
...
Private Function ShowNextLast()
 ...
 If Int_curpage>=int_totalpage Then
  str_tmp="<li><span>"&Btn_Next&"</span></li>" & VbCrLf
  str_tmp=str_tmp&"<li><span>"& Btn_Last & "</span></li>" & VbCrLf
 Else
  Int_NextPage=int_curpage+1
  str_tmp="<li><a href=""" & XD_sURL & CStr(int_nextpage) & """>" & Btn_Next&"</a></li>" & VbCrLf
  str_tmp=str_tmp&"<li><a href="""& XD_sURL & CStr(int_totalpage) & """>" &  Btn_Last&"</a></li>" & VbCrLf
 End If
...
str_tmp=str_tmp&"<li><span>0</span></li>" & VbCrLf
else
if int_curpage>1 then
...
strTemp=XD_sURL & CStr(i)
  ...
  str_tmp=str_tmp & "<li><span>"&i&"</span></li>" & VbCrLf
  else
  str_tmp=str_tmp & "<li><a href=""" & XD_sURL & CStr(i) & """>"&i&"</a></li>" & VbCrLf
  end if
Next
end if
showNumBtn=str_tmp
