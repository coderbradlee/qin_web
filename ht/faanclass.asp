...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=5 height=25>方案类型管理</th>	
  </tr>
  <tr>
    ...
    <%set rs=server.CreateObject("adodb.recordset")
		  rs.Open "select * from jiedai_faclass order by flag asc ",conn,1,1
		  dim paixu
		  ...
		  do while not rs.EOF
	%>
     <form name="form1" method="post" action="savefaanclass.asp?action=edit&id=<%=int(rs("id"))%>">
    <tr>
     ...
     <td class="forumRowHighlight"><div align="center"><input class="button" type="submit" name="Submit" value="修  改">&nbsp; <a href="savefaanclass.asp?id=<%=int(rs("id"))%>&action=del" onClick="return confirm('此操作会删除此大类下包含的小分类和商品！您确定进行删除操作吗？')"><font color=red>删除</font></a> </div></td>
   </tr>
   </form>
   <%rs.MoveNext
          loop
...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=5 height=25>添加方案类型</th>	
  </tr>
  <tr> 
  ...
  <tr>
    <td width="33%" class="forumRowHighlight"><div align="center">类型名称</div></td>
   <td width="21%" class="forumRowHighlight"><div align="center">方案排序</div></td>
   <td width="31%" class="forumRowHighlight"><div align="center">确定操作</div></td>
 </tr>
 <form name="form1" method="post" action="savefaanclass.asp?action=add">
  <tr>
