...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=7 height=25>区域管理</th>	
  </tr>
  <tr>
    <td width="15%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">中文名称</div></td>
    <td width="20%" align="center" bgcolor="#CFDEEB" class="forumRowHighlight">英文名称</td>
    <td width="36%" align="center" bgcolor="#CFDEEB" class="forumRowHighlight">标示图</td>
    <td width="10%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">区域排序</div></td>
    <td width="19%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">确定操作</div></td>
  </tr>
    ...
    <tr>
      ...
      <table width="50%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="padding-left:8px"><iframe src="jiedai_up.asp?ffs=form1p&id=tu<% =rs("id") %>" width="270" marginwidth="0" height="25" marginheight="0" scrolling="no" frameborder="0"></iframe></td>
              </tr>
            </table>
...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  <tr height=25> 
	<th class="tableHeaderText" colspan=7 height=25>添加区域</th>	
  </tr>
  <tr> 
    <td class="forumRowHighlight" colspan=5 ><div align="center">注意：各项名称不能含有非法字符</div></td>
  </tr>
  <tr>
    <td width="14%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">中文名称</div></td>
    <td width="16%" align="center" bgcolor="#CFDEEB" class="forumRowHighlight">英文名称</td>
    <td width="41%" align="center" bgcolor="#CFDEEB" class="forumRowHighlight">标示图</td>
    <td width="11%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">区域排序</div></td>
   <td width="18%" bgcolor="#CFDEEB" class="forumRowHighlight"><div align="center">确定操作</div></td>
 </tr>
  ...
  <tr>
    ...
    <table width="50%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="padding-left:8px"><iframe src="jiedai_up.asp?ffs=form1s&id=tupp" width="270" marginwidth="0" height="25" marginheight="0" scrolling="no" frameborder="0"></iframe></td>
              </tr>
            </table>
