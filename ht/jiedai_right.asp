...
if trim(request.form("submit"))="修改" then
  ...
  if weburl<>"" then
	...
	dim rs,sql
	set rs=server.createobject("adodb.recordset")
	sql="select * from jiedai_right where id="&id
	rs.open sql,conn,1,3
	rs("title")=request.form("title")
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="6">
   <tr>
     ...
     <td width="82%" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" bordercolor="#cccccc" background="images/bg_title.gif">
       <tr align="center">
         <td align="center" bgcolor="#DFEFFF"><strong>厂房设备</strong></td>
         </tr>
     </table>
       <br>
...
set rs=server.createobject("adodb.recordset")
	...
	sql="select * from jiedai_right order by id desc "
