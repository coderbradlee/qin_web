...
<form id="form2" name="form2" method="post" action="?action=delAll" class="border-padd0">
  <table width="98%" height="32" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td align="center" bgcolor="#DBF5FD" class="fontb">管理应聘信息</td>
      <td width="13" bgcolor="#DBF5FD">&nbsp;</td>
    </tr>
  </table>
     <%
...
%> 
 <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#C7D5E0">
    ...
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="1" colspan="3" align="right" >姓 名： </td>
      <td align="left" ><%=rs("tname")%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="3" colspan="3" align="right" >性 别：</td>
      <td align="left" ><%=rs("sex")%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="7" colspan="3" align="right" >出生年月： </td>
      <td align="left" ><%=rs("sr")%></td>
    </tr>
	   <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="7" colspan="3" align="right" >籍贯： </td>
      <td align="left" ><%=rs("jg")%></td>
    </tr>
	
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="15" colspan="3" align="right" >联系电话：</td>
      <td align="left" ><%=rs("tel")%></td>
    </tr>
    
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >联系邮箱：</td>
      <td align="left" ><%=rs("email")%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >现住址：</td>
      <td align="left" ><%=rs("add")%></td>
    </tr>
	    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >学历：</td>
      <td align="left" ><%=rs("xl")%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >工作经验：</td>
      <td align="left" ><%=rs("jy")%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >应聘时间：</td>
      <td align="left" ><%=rs("times")%></td>
    </tr>
	   <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >说明：</td>
      <td align="left" ><%if rs("body")<>"" then response.write rs("body") else response.write "没有输入要求" end if%></td>
    </tr>
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td colspan="3" align="right" >个人简历：</td>
      <td align="left" ><%if rs("content")<>"" then response.write cutstr(removehtml(rs("content")),100) else response.write "没有输入要求" end if%></td>
    </tr>
    
    <tr bgcolor="#F9F9F9" onMouseOver="this.style.backgroundColor='#EAFCD5';" onMouseOut="this.style.backgroundColor='';this.style.color=''">
      <td height="24" colspan="3" align="right" >操作：</td>
      <td align="left" >&nbsp;&nbsp;      <a href="edit.asp?action=edit&amp;id=<%=rs("ID")%>&page=<%=page%>">编辑</a> | <a  onclick='{if(confirm("您确定删除吗?此操作将不能恢复!")){return true;}return false;}' href="?ac=del&amp;id=<%=rs("ID")%>&amp;page=<%=page%>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;选择
...
ElseIf Request("Del")="更新时间" Then
   ...
   Response.Write("<script>alert('操作成功!');location='list.asp'</script>")
...
Next
 Response.Write("<script>alert('操作成功!');location='list1.asp'</script>")
...
ElseIf Request("Del")="删除" Then
	'set rs=conn.execute("delete from news where ID In(" & ID & ")")
			...
			next
			response.write "<script>alert('删除成功!');location='list1.asp'</script>"
End If
End Sub
