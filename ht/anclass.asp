...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
  ...
  <tr>
    <td width="17%" class="forumRowHighlight"><div align="center">中文名称</div></td>
    <td width="16%" align="center" class="forumRowHighlight">英文名称</td>
    <td width="21%" class="forumRowHighlight"><div align="center">区域排序</div></td>
    ...
    <%set rs=server.CreateObject("adodb.recordset")
		  ...
		  do while not rs.EOF
	%>
     <form name="form1" method="post" action="savepanclass.asp?action=edit&id=<%=int(rs("anclassid"))%>">
    <tr>
      <td class="forumRowHighlight"><div align="center"><input name="anclass" type="text" id="anclass" size="12" value="<%=trim(rs("anclass"))%>"></div></td>
	  <td align="center" class="forumRowHighlight"><input name="e_anclass" type="text" id="e_anclass" size="12" value="<%=trim(rs("e_anclass"))%>"></td>
     ...
     <td class="forumRowHighlight"><div align="center"><input class="button" type="submit" name="Submit" value="修  改">&nbsp; <a href="savepanclass.asp?id=<%=int(rs("anclassid"))%>&action=del" onClick="return confirm('此操作会删除此大类下包含的小分类和商品！您确定进行删除操作吗？')">
...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="tableBorder" align=center>
 ...
 <form name="form1" method="post" action="savepanclass.asp?action=add">
  <tr>
