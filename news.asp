...
<%
 ...
 <div class="ncenter">
    ...
    <ul class="nbody">
	  ...
	  <div class="news_home">
 			 <ul class="news_hti"><h1><% =res("classname") %></h1> <a href="news_list.asp?a=<% =res("id") %>" >more</a></ul>
          <ul class="news_main">
  ...
  <%
					...
					sql="select top 6 * from zhibenhui_news  where classid="&res("id")&" order by id desc"
